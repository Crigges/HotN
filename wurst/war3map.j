...
function main takes nothing returns nothing
    call SetCameraBounds( -24320.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), -14848.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM), 23296.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), 16384.0 - GetCameraMargin(CAMERA_MARGIN_TOP), -24320.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), 16384.0 - GetCameraMargin(CAMERA_MARGIN_TOP), 23296.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), -14848.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM) )
    call SetDayNightModels( "Environment\\DNC\\DNCLordaeron\\DNCLordaeronTerrain\\DNCLordaeronTerrain.mdl", "Environment\\DNC\\DNCLordaeron\\DNCLordaeronUnit\\DNCLordaeronUnit.mdl" )
    call SetTerrainFogEx( 0, 0.0, 10000.0, 0.500, 0.314, 0.235, 0.157 )
...
function config takes nothing returns nothing
    ...
    call DefineStartLocation( 0, -11840.0, 5376.0 )
    call DefineStartLocation( 1, -11840.0, 5376.0 )
    call DefineStartLocation( 2, -11840.0, 5376.0 )
    call DefineStartLocation( 3, -11840.0, 5376.0 )
    call DefineStartLocation( 4, -11840.0, 5376.0 )
    call DefineStartLocation( 5, -11840.0, 5376.0 )
    call DefineStartLocation( 6, 12928.0, 5376.0 )
    call DefineStartLocation( 7, 12928.0, 5376.0 )
    call DefineStartLocation( 8, 12928.0, 5376.0 )
    call DefineStartLocation( 9, 12928.0, 5376.0 )
    call DefineStartLocation( 10, 12928.0, 5376.0 )
    call DefineStartLocation( 11, 12928.0, 5376.0 )
